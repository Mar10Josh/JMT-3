...
#ifndef JOSIAH_MODDING_TOOLS_3_SWIFT_H
#define JOSIAH_MODDING_TOOLS_3_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Josiah_Modding_Tools_3",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22Josiah_Modding_Tools_311AppDelegate")
...
- (void)confirmConfiguration:(ConfigurationIntent * _Nonnull)intent completion:(void (^ _Nonnull)(ConfigurationIntentResponse * _Nonnull))completionHandler SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
...
- (void)handleConfiguration:(ConfigurationIntent * _Nonnull)intent completion:(void (^ _Nonnull)(ConfigurationIntentResponse * _Nonnull))completionHandler SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
@end
...
SWIFT_CLASS("_TtC22Josiah_Modding_Tools_314ViewController")
